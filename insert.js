require(['jquery-1.9','bump-3'],function (jquery, $) {
  jquery('body').append("<div class='myradio'><div class='bar'><div class='barinner'><div class='header'>Rory's radio</div><img class='episodepic' src='#'' /><div class='playing_panel'><div id='audioicon'><div class='bars'></div><div class='bars'></div><div class='bars'></div><div class='bars'></div><div class='bars'></div></div><div class='duration'>1:23:00 / 3:00:00</div><div class='nowplaying'>Gilles Peterson <span class='episode'>Howie B in conversation</span></div></div><div class='track_panel'><img class='trackpic' src='#' /><img class='playlister' src='https://dl.dropboxusercontent.com/u/15226972/myradio/img/playlister.png' /><div class='duration'>TRACK NOW PLAYING</div><div class='trackplaying'><span class='artist'>Artist name</span> <span class='title'>Howie B in conversation</span></div></div></div></div><div class='drawer'><div class='drawer_inner'><div class='recent'></div></div></div></div>");
...
function showUser (user){
  jquery('.header').text(user.get("Name")+"'s Radio");
  jquery('.nowplaying').text(user.get("NowPlaying"));
...
function showTrack(track){
  console.log(track);
  jquery('.title').text(track.title);
  jquery('.artist').text(track.artist);
